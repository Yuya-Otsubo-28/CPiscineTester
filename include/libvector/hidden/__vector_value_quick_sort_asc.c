...
void __vector_value_quick_sort_asc(void *v1, void *v2, uint64_t mem_size, uint64_t length, int(* cmp_function)(void *v1, void *v2)){
    ...
    if (length != 2) {
        ...
        __vector_value_quick_sort_asc (v2, v1, mem_size, p_begin++, cmp_function);
        __vector_value_quick_sort_asc (v2+mem_size*p_begin, v1+mem_size*p_begin, mem_size, length-p_begin, cmp_function);
    }
